...
[ -z "$LMIAB_SSH_LIGHTSAIL_KEYPAIR_NAME" ] && LMIAB_SSH_LIGHTSAIL_KEYPAIR_NAME="miab"
[ -z "$LMIAB_SSH_PRIVATE_KEY_FILE" ] && LMIAB_SSH_PRIVATE_KEY_FILE="$HOME/.ssh/miab"
[ -z "$LMIAB_FIREWALL_SSH_ALLOW_CIDR" ] && LMIAB_FIREWALL_SSH_ALLOW_CIDR="0.0.0.0/0"
[ -z "$LMIAB_DRY_RUN" ] && LMIAB_DRY_RUN="no"
[ -z "$LMIAB_AZ" ] && LMIAB_AZ="ca-central-1a"
